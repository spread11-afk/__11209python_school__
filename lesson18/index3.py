...
class MyFrame(ttk.LabelFrame):
    def __init__(self, master,title,**kwargs) -> None:
        ...
        ttk.Radiobutton(self,text='左邊',value='left',variable=self.aligement).grid(column=0,row=0,padx=10)
        ttk.Radiobutton(self,text='中間',value='center',variable=self.aligement).grid(column=1,row=0,padx=10)
        ttk.Radiobutton(self,text='右邊',value='right',variable=self.aligement).grid(column=2,row=0,padx=10)
